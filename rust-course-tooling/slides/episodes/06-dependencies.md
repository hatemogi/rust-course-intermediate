...
<div class="grid grid-cols-2 gap-10 mt-10">
  <div>
    ...
    <p>프로젝트가 어떤 의존성 범위를 허용하는지 사람이 선언합니다.</p>
  </div>
  <div>
    <h2><code>Cargo.lock</code></h2>
    <p>Cargo가 실제로 선택한 직접·간접 의존성의 정확한 버전과 출처를 기록합니다.</p>
  </div>
</div>

<div class="takeaway"><code>Cargo.lock</code>은 직접 편집하지 않고 Cargo 명령으로 갱신합니다.</div>
...
출력이 길다면 패키지를 지정해 어느 경로에서 feature가 활성화됐는지 거꾸로
살펴봅니다.

<div class="takeaway">의존성 이름만 보지 말고 누가 가져왔고 어떤 feature를 켰는지 확인합니다.</div>
...
다음 편에서는 Cargo feature별 코드와 API 문서를 함께 검사합니다.
